...
{
    public class SingleCylinder : Cylinder
    {
        #region "字段"
        ...
        #endregion
        public SingleCylinder(Sensor InOrigin, Sensor InMove, Signal OutMove)
        {
            _InOrigin = InOrigin;
            _InMove = InMove;
            _OutMove = OutMove;
        ...
        public SingleCylinder(CylinderCondition cylinderCondition, CylinderDelay cylinderDelay, Sensor InOrigin,Sensor InMove,Signal OutMove)
            :this(InOrigin, InMove,  OutMove)
        {
