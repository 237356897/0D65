...
namespace Motion.Enginee
{
    ...
    public abstract class Axis<TMotionPathId, TVelocityCurve> : Automatic, IAxis<TMotionPathId, TVelocityCurve>
    {
        ...
        ///     当前 Absolute 位置。
        /// </summary>
        public abstract int CurrentPos { get; }
        /// <summary>
        /// 当前速度
        /// </summary>
        ...
        public abstract void MoveTo(int value, TVelocityCurve velocityCurve = default(TVelocityCurve));
        ...
        public abstract void MoveDelta(int value, TVelocityCurve velocityCurve = default(TVelocityCurve));
